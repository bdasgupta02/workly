...
_ProjectTasksAllState projectTasksAllState;

class ProjectTasksAll extends StatefulWidget {
  @override
  // _ProjectTasksAllState createState() => _ProjectTasksAllState();
  _ProjectTasksAllState createState() {
    projectTasksAllState = _ProjectTasksAllState();
    return projectTasksAllState;
  }
}

class _ProjectTasksAllState extends State<ProjectTasksAll> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xFFE9E9E9),
      body:_buildTaskAllList(),// Tester.test(),
  ...
  Widget _buildTaskAllList() {
    final database = Provider.of<ProjectDatabase>(context, listen: false);
    return StreamBuilder<List<TaskModel>>(
      stream: database.taskStream(),
